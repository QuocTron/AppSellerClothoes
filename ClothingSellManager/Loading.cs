...
namespace ClothingSellManager
{
    public partial class Loading : Form
    {
            ...
            for (int i = 0; i < 7; i++)
            {
                switch (i)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        pictureBox10.Location = new Point(pictureBox10.Location.X, pictureBox10.Location.Y + rainspeed[i]);
        ...
        {
            initialPercentage += loadspeed;
            float percentage = initialPercentage / pictureBox2.Height * 100;
            label1.Text = (int)percentage + " %";
            panel2.Location = new Point(panel2.Location.X, panel2.Location.Y + loadspeed);
            if (panel2.Location.Y > pictureBox2.Location.Y + pictureBox2.Size.Height)
            {
                label1.Text = "100 %";
                this.timer2.Stop();
